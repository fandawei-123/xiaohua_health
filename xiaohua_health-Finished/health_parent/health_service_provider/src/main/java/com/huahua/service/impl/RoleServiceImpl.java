...
import com.huahua.dao.MenuDao;
import com.huahua.dao.PermissionDao;
...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public Set getMenuByRoleByUserName(String username) {
        Set menus = new HashSet();
        Set<Role> roles = roleDao.findByUserId(userDao.findByUsername(username).getId());
        for (Role role : roles) {
            Set<Menu> findmenus = menuDao.findByRole(role.getId());
