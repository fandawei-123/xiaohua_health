...
@Controller
@Configuration
@ComponentScan("com.huahua.controller")
...
public class LogAopController {
     ...
     */
    @Before("execution(* com.huahua.controller.*.*(..))")//.*是包下的所有类 .*是类下的所有方法
     ...
     * @param jp
     */
    @After("execution(* com.huahua.controller.*.*(..))")
    public void doAfter(JoinPoint jp) {
        //4如何获取执行的时长?
        String time = String.valueOf(System.currentTimeMillis() - visitTime.getTime());
        //3如何获取访问的url
        String url = "";
        ...
        syslog.setConsumerName("xiaohuaHome");
